...
def main(record_trajectory_path, generalized_dmp_trajectory_path,
         starting_angles, ending_angles ):
    dmp = Dmp()
...
#           joint3_data[0], joint4_data[0],joint5_data[0], joint6_data[0] ]
    x_0 = starting_angles
...
#    generalized_dmp_path = "tmp.txt"
#    starting_angles = [ 0.7202039799122018, -0.6017039640480536,-0.32750489821353584, 0.9610389636102117,
#    0.2381505173192105, 1.2344710390507867, -1.2724370635509508]
#     main(record_trajectory_path, generalized_dmp_trajectory_path, starting_angles, ending_angles )
